...
import config
from Team-Legit-X-Music import BOT_MENTION, BOT_NAME, app
from Team-Legit-X-Music.Help import gp_buttons, pm_buttons
from Team-Legit-X-Music.Help.dossier import *
